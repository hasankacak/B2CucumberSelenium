...
public class Login_stepDefs {
    ...
    public void the_user_enters_hasan_credentials() {
    ...
    public void theUserEntersJhanNashCredentials() {
        System.out.println("I enter Jhan Nash username and password and click login button");
    }
